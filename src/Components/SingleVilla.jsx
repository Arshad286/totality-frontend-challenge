...
const SingleVilla = () => {
  ...
  const handleAddToCart = () => {
    addToCart(filteredVilla.id); // Pass the entire villa object to addToCart
    history("/Cart"); // Navigate to the cart component after adding to cart
  };
    ...
    <>
      <section id="singleVilla" className="page">
        <div className="container">
          ...
          <NavLink to="/cart">
            <button onClick={handleAddToCart} className='checkout'>ADD TO CART</button>
          </NavLink>
        </div>
      </section>
    </>
